...
// ١. لاپەڕەی چوونەژوورەوە و دروستکردنی هەژمار
app.get('/', (req, res) => {
    res.send(`
        <!DOCTYPE html>
...
// ٢. داشبۆردی سەرەکی (لەگەڵ لینکی تایبەتی پڕۆفایل)
...
// ٣. لاپەڕەی دروستکردنی لینک بایۆ و وێنە
...
// ٥. لاپەڕەی باڵانس و پڕکردنەوەی پارە
...
app.get('/profile', (req, res) => {
    res.send(`
        ...
        <head>
            ...
            <style>
                * { box-sizing: border-box; margin: 0; padding: 0; font-family: system-ui, sans-serif; }
                body { min-height: 100vh; display: flex; justify-content: center; align-items: center; padding: 20px; transition: 0.3s; }
                ...
                .card { background: rgba(22, 27, 34, 0.85); backdrop-filter: blur(10px); padding: 40px 25px; border-radius: 24px; border: 1px solid #30363d; width: 100%; max-width: 400px; text-align: center; box-shadow: 0 20px 40px rgba(0,0,0,0.5); }
                ...
                .avatar-img { width: 90px; height: 90px; border-radius: 50%; object-fit: cover; margin: 0 auto 15px auto; border: 3px solid #00f2fe; display: none; }
                ...
                p { font-size: 15px; margin-bottom: 25px; opacity: 0.8; }
